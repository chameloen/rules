...
^(http|https):\/\/(www.)?(betterzipcn|betterzip)\.(com|net)\/ url 302 https://macitbetter.com/
...
^(http|https):\/\/(www.)?codesoftchina\.com\/ $1://www.teklynx.com/ 302
^(http|https):\/\/(www.)?coreldrawchina\.com\/ $1://www.coreldraw.com/cn/ 302
^(http|https):\/\/(www.)?crossoverchina\.com\/ $1://www.codeweavers.com/ 302
^(http|https):\/\/(www.)?dongmansoft\.com\/ $1://$2.udongman.cn/ 302
^(http|https):\/\/(www.)(qiktckc)(.+) $1$3 302
^(http|https):\/\/(www.)?earmasterchina\.cn\/ $1://$2.earmaster.com/ 302
^(http|https):\/\/(www.)?easyrecoverychina\.com\/ $1://$2.ontrack.com/  302
...
^(http|https):\/\/(www.)?guitarpro\.cc\/ $1://$2.guitar-pro.com/ 302
...
^(http|https):\/\/(www.)?kingdeecn\.cn\/ $1://$2.kingdee.com/ 302
...
^(http|https):\/\/(www.)(imatype)(.+) $1$3 302
...
^(http|https):\/\/(www.)?ntfsformac\.cc\/ $1://$2.tuxera.com/products/tuxera-ntfs-for-mac-cn/ 302
...
^(http|https):\/\/(www.)?shankejingling\.com\/ https://www.sothink.com/product/flashdecompiler/
^(http|https):\/\/cn\.ultraiso\.net\/ $1://$2.ezbsystems.com/ultraiso/ 302
...
# AbeamTV
^(http|https):\/\/api\.abema\.io\/v\d\/ip\/check _ reject

[MITM]
hostname = %APPEND% *.tiktokv.com,*.byteoversea.com,www.google.cn,api.abema.io,prom.mobile.gome.com.cn,y.gtimg.cn,du.hupucdn.com,*.xzcs3zlph.com,*.tik-tokapi.com,interfac*.music.163.com,yxyapi2.drcuiyutao.com,api.vistopia.com.cn,capis-clb.didapinche.com,api.jxedt.com,mi.gdt.qq.com,richmanapi.jxedt.com,nfmovies.com,app-api.smzdm.com,emdcadvertise.eastmoney.com,101.201.175.228,182.92.251.11
